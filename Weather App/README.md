...
- A Java-based application that provides users with real-time weather information for a specified location. 
- It fetches weather data from an external API and displays it in a graphical user interface (GUI). 
...
<p align="center">
    <img src="https://github.com/SanjeebLama/Java-Workspace/blob/master/Weather%20App/screenshot.png?raw=true" align="center">
</p>
